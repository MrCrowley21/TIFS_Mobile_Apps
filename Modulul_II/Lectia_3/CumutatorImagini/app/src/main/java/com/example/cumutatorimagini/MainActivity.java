package com.example.cumutatorimagini;
        ...
        btnViewWindows.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext()
                        , "Vezi lumina albastra",Toast.LENGTH_LONG).show();
                imgSwitcher.setImageResource(R.mipmap.light1);
            }
        });
        btnViewButterfly.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "Vezi lumina rosie"
                        ,Toast.LENGTH_LONG).show();
                imgSwitcher.setImageResource(R.mipmap.light2);
            }
        });
    }
}